...
describe('VoiceCommandRouter', () => {
  ...
  it('forces DeepSeek when the user explicitly asks for AI help', async () => {
  ...
  it('falls back to fuzzy offline parsing when DeepSeek fails', async () => {
  ...
  it('converts multiple DeepSeek tool calls to canvas commands', () => {
